...
use crate::enums::{CorrelationVectorVersion, SpinCounterInterval, SpinCounterPeriodicity, SpinEntropy};
use crate::spin_parameters::SpinParameters;
...
impl CorrelationVector {
    ...
    pub fn spin(correlation_vector: &str, validate_correlation_vector_during_creation: bool) -> CorrelationVector {
        let default_parameters = SpinParameters::new(SpinCounterInterval::Coarse,
    ...
    pub fn spin_with_params(correlation_vector: &str, parameters: SpinParameters, validate_correlation_vector_during_creation: bool) -> CorrelationVector {
        ...
        // Generate a bit-mask and mask the lower total_bits in the value.
